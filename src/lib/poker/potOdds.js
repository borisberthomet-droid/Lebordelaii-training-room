...
export const QUESTION_TYPES = ["call_equity", "bluff_fold_equity", "bluff_ratio", "value_bet_equity"];
...
export function generateSpot() {
  ...
  return { pot, bet, betPct, isRaise, questionType };
}

export function computeAnswer({ pot, bet, questionType }) {
