...
import { getMathTrainerRanking } from "@/lib/supabase/mathTrainerAttempts";
import { ACCENT } from "@/lib/poker/constants";
import { MathTrainerIcon } from "@/components/ToolIcons";

const MIN_QUESTIONS = 10;

export default function MathTrainerRankingPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        setRanking(await getMathTrainerRanking(MIN_QUESTIONS));
      } finally {
        setLoading(false);
      }
    })();
